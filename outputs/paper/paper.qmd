...
The raw-data is archieved from a research about disparties of police nomination in Chicago.
...
duration_of_officer <- month_data |>
  group_by(nuid) |>
  summarise(total_month = max(unit_duration))
