...
comp_awd <- ggplot(all_officer, aes(x = Complaints, y = awd_perf)) + 
  ggtitle("Plot of Award Nomination by Number of Complaints") +
...
arr_awd <- ggplot(all_officer, aes(x = arrest, y = awd_perf)) + 
  ggtitle("Plot of Award Nomination by Number of Arrests") +
